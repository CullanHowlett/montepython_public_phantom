...
class eBOSS_DR16_Lya_cross(Likelihood):
    ...
    def __init__(self, path, data, command_line):
        ...
        if 'eBOSS_DR14_Lya_cross' in data.experiments:
            raise io_mp.LikelihoodError(
                'conflicting eBOSS_DR14_Lya_auto measurements')
        if 'eBOSS_DR14_Lya_combined' in data.experiments:
            raise io_mp.LikelihoodError(
                'conflicting eBOSS_DR14_Lya_combined measurements')
        ...
        scan_locations = {}
        scan_locations['xcf'] = self.data_directory + '/' + self.cf_scan
